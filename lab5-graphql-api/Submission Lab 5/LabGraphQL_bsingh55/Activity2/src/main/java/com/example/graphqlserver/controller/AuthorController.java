...
public class AuthorController {
    ...
    /**
     * Task 2: Query to get authors by last name.
     */
    @QueryMapping
    ...
    /**
     * Task 3: Mutation to update an author's first name based on their unique ID.
     */
    @MutationMapping
    public String updateAuthorFirstName(@Argument int id, @Argument String newFirstName) {
    return authorRepository.updateAuthorFirstName(id, newFirstName);
    }
